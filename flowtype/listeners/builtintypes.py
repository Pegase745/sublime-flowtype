...
builtintypes = [
    ...
    print_type_format("Diff", "\$Diff<${1}, ${2}>",
    ...
    print_type_format("PropertyType", "\$PropertyType<${1}, ${2}>",
                      "Flow built-in private type"),
    print_type_format(
    ...
    print_type_format("AsyncIterable", "AsyncIterable<${1}>",
                      "Flow core type"),
    print_type_format("AsyncIterator", "AsyncIterator<${1}>",
                      "Flow core type"),
    ...
    print_type_format("IteratorResult", "IteratorResult<${1}, ${2}>",
                      "Flow core type"),
    ...
    # Core 'private' types
    print_type_format("ArrayBufferView", "\$ArrayBufferView",
                      description="Flow core private type"),
    print_type_format("ReadOnlyArray", "\$ReadOnlyArray<${1}>",
                      description="Flow core private type"),
    print_type_format("SymboIsConcatSpreadable", "\$SymboIsConcatSpreadable",
                      description="Flow core private type"),
    print_type_format("SymbolHasInstance", "\$SymbolHasInstance",
                      description="Flow core private type"),
    print_type_format("SymbolIterator", "\$SymbolIterator",
                      description="Flow core private type"),
    print_type_format("SymbolMatch", "\$SymbolMatch",
                      description="Flow core private type"),
    print_type_format("SymbolReplace", "\$SymbolReplace",
                      description="Flow core private type"),
    print_type_format("SymbolSearch", "\$SymbolSearch",
                      description="Flow core private type"),
    print_type_format("SymbolSpecies", "\$SymbolSpecies",
                      description="Flow core private type"),
    print_type_format("SymbolSplit", "\$SymbolSplit",
                      description="Flow core private type"),
    print_type_format("SymbolToPrimitive", "\$SymbolToPrimitive",
                      description="Flow core private type"),
    print_type_format("SymbolToStringTag", "\$SymbolToStringTag",
                      description="Flow core private type"),
    print_type_format("SymbolUnscopables", "\$SymbolUnscopables",
                      description="Flow core private type"),
    print_type_format("TypedArray", "\$TypedArray",
                      description="Flow core private type"),
    print_type_format("Proxyrevocable", "Proxy\$revocable<${1}>",
                      description="Flow core private type"),
    print_type_format("Proxytraps", "Proxy\$traps<${1}>",
                      description="Flow core private type"),
    print_type_format("RegExpflags", "RegExp\$flags",
                      description="Flow core private type"),

    # React types
    print_type_format("_ReactClass", "_ReactClass<${1}, ${2}, ${3}, ${4}>",
                      "Flow React type"),
    print_type_format("LegacyReactComponent",
                      "LegacyReactComponent<${1}, ${2}, ${3}>",
                      "Flow React type"),
    print_type_format("ReactClass", "ReactClass<${1}>", "Flow React type"),
    print_type_format("ReactPropsChainableTypeChecker",
    ...
    print_type_format("SyntheticClipboardEvent",
                      description="Flow React type"),
    print_type_format("SyntheticCompositionEvent",
                      description="Flow React type"),
    ...
    # React 'private' types
    print_type_format("DefaultPropsOf", "\$DefaultPropsOf<${1}>",
                      "Flow React type"),
    print_type_format("JSXIntrinsics", "\$JSXIntrinsics", "Flow React type"),
    print_type_format("PropsOf", "\$PropsOf<${1}>", "Flow React type"),
    print_type_format("ReactComponent",
                      "React\$Component<${1}, ${2}, ${3}>", "Flow React type"),
    print_type_format("ReactElement", "React\$Element<${1}>",
                      "Flow React type"),
    print_type_format("ReactPropTypesarrayOf",
                      "React\$PropTypes\$arrayOf", "Flow React type"),
    print_type_format("ReactPropTypesinstanceOf",
                      "React\$PropTypes\$instanceOf", "Flow React type"),
    print_type_format("ReactPropTypesobjectOf",
                      "React\$PropTypes\$objectOf", "Flow React type"),
    print_type_format("ReactPropTypesoneOf",
                      "React\$PropTypes\$oneOf", "Flow React type"),
    print_type_format("ReactPropTypesoneOfType",
                      "React\$PropTypes\$oneOfType", "Flow React type"),
    print_type_format("ReactPropTypesshape",
                      "React\$PropTypes\$shape", "Flow React type"),
    print_type_format("React$PureComponent",
    ...
    print_type_format("ElementRegistrationOptions",
    ...
    print_type_format("EventListenerOptionsOrUseCapture",
                      description="Flow DOM type"),
    ...
    print_type_format("HTMLCollection", "HTMLCollection<${1}>",
                      "Flow DOM type"),
    ...
    print_type_format("NodeIterator", "NodeIterator<${1}, ${2}>",
                      "Flow DOM type"),
    ...
    print_type_format("CustomEventInit", "CustomEvent\$Init",
    ...
    print_type_format("DedicatedWorkerGlobalScope",
    ...
    print_type_format("MediaElementAudioSourceNode",
                      description="Flow BOM type"),
    print_type_format("MediaStream", description="Flow BOM type"),
    print_type_format("MediaStreamAudioSourceNode",
                      description="Flow BOM type"),
    ...
    print_type_format("MutationObserverInitRequired",
                      description="Flow BOM type"),
    ...
    print_type_format("PerformanceEntryFilterOptions",
                      description="Flow BOM type"),
    print_type_format("PerformanceNavigation", description="Flow BOM type"),
    print_type_format("PerformanceNavigationTiming",
                      description="Flow BOM type"),
    print_type_format("PerformanceResourceTiming",
                      description="Flow BOM type"),
    ...
    print_type_format("readableStreamOptions",
                      description="Flow Node.js type"),
    print_type_format("writableStreamOptions",
                      description="Flow Node.js type"),
    ...
    print_type_format("bufferEncoding", "buffer\$Encoding",
                      "Flow Node.js private type"),
    print_type_format("bufferNonBufferEncoding", "buffer\$NonBufferEncoding",
                      "Flow Node.js private type"),
    print_type_format("bufferToJSONRet", "buffer\$ToJSONRet",
                      "Flow Node.js private type"),
    print_type_format("child_processChildProcess",
                      "child_process\$ChildProcess",
                      "Flow Node.js private type"),
    print_type_format("child_processError", "child_process\$Error",
                      "Flow Node.js private type"),
    print_type_format("child_processexecCallback",
                      "child_process\$execCallback",
                      "Flow Node.js private type"),
    print_type_format("child_processexecFileCallback",
                      "child_process\$execFileCallback",
                      "Flow Node.js private type"),
    print_type_format("child_processexecFileOpts",
                      "child_process\$execFileOpts",
                      "Flow Node.js private type"),
    print_type_format("child_processexecFileSyncOpts",
                      "child_process\$execFileSyncOpts",
                      "Flow Node.js private type"),
    print_type_format("child_processexecOpts", "child_process\$execOpts",
                      "Flow Node.js private type"),
    print_type_format("child_processexecSyncOpts",
                      "child_process\$execSyncOpts",
                      "Flow Node.js private type"),
    print_type_format("child_processforkOpts", "child_process\$forkOpts",
                      "Flow Node.js private type"),
    print_type_format("child_processHandle", "child_process\$Handle",
                      "Flow Node.js private type"),
    print_type_format("child_processspawnOpts", "child_process\$spawnOpts",
                      "Flow Node.js private type"),
    print_type_format("child_processspawnRet", "child_process\$spawnRet",
                      "Flow Node.js private type"),
    print_type_format("child_processspawnSyncOpts",
                      "child_process\$spawnSyncOpts",
                      "Flow Node.js private type"),
    print_type_format("child_processspawnSyncRet",
                      "child_process\$spawnSyncRet",
                      "Flow Node.js private type"),
    print_type_format("clustersetupMasterOpts", "cluster\$setupMasterOpts",
                      "Flow Node.js private type"),
    print_type_format("clusterWorker", "cluster\$Worker",
                      "Flow Node.js private type"),
    print_type_format("cryptoCipher", "crypto\$Cipher",
                      "Flow Node.js private type"),
    print_type_format("cryptocreateCredentialsDetails",
                      "crypto\$createCredentialsDetails",
                      "Flow Node.js private type"),
    print_type_format("cryptoCredentials", "crypto\$Credentials",
                      "Flow Node.js private type"),
    print_type_format("cryptoDecipher", "crypto\$Decipher",
                      "Flow Node.js private type"),
    print_type_format("cryptoDiffieHellman", "crypto\$DiffieHellman",
                      "Flow Node.js private type"),
    print_type_format("cryptoHash", "crypto\$Hash",
                      "Flow Node.js private type"),
    print_type_format("cryptoHmac", "crypto\$Hmac",
                      "Flow Node.js private type"),
    print_type_format("cryptoSign", "crypto\$Sign",
                      "Flow Node.js private type"),
    print_type_format("cryptoSignprivate_key", "crypto\$Sign\$private_key",
                      "Flow Node.js private type"),
    print_type_format("cryptoVerify", "crypto\$Verify",
                      "Flow Node.js private type"),
    print_type_format("dgramSocket", "dgram\$Socket",
                      "Flow Node.js private type"),
    print_type_format("domainDomain", "domain\$Domain",
                      "Flow Node.js private type"),
    print_type_format("eventsEventEmitter", "events\$EventEmitter",
                      "Flow Node.js private type"),
    print_type_format("httpClientRequest", "http\$ClientRequest",
                      "Flow Node.js private type"),
    print_type_format("httpIncomingMessage", "http\$IncomingMessage",
                      "Flow Node.js private type"),
    print_type_format("httpServerResponse", "http\$ServerResponse",
                      "Flow Node.js private type"),
    print_type_format("netconnectOptions", "net\$connectOptions",
                      "Flow Node.js private type"),
    print_type_format("netServer", "net\$Server",
                      "Flow Node.js private type"),
    print_type_format("netSocket", "net\$Socket",
                      "Flow Node.js private type"),
    print_type_format("netSocketaddress", "net\$Socket\$address",
                      "Flow Node.js private type"),
    print_type_format("osCPU", "os\$CPU",
                      "Flow Node.js private type"),
    print_type_format("osNetIFAddr", "os\$NetIFAddr",
                      "Flow Node.js private type"),
    print_type_format("osUserInfobuffer", "os\$UserInfo\$buffer",
                      "Flow Node.js private type"),
    print_type_format("osUserInfostring", "os\$UserInfo\$string",
                      "Flow Node.js private type"),
    print_type_format("readlineInterface", "readline\$Interface",
                      "Flow Node.js private type"),
    print_type_format("streamDuplex", "stream\$Duplex",
                      "Flow Node.js private type"),
    print_type_format("streamPassThrough", "stream\$PassThrough",
                      "Flow Node.js private type"),
    print_type_format("streamReadable", "stream\$Readable",
                      "Flow Node.js private type"),
    print_type_format("streamStream", "stream\$Stream",
                      "Flow Node.js private type"),
    print_type_format("streamTransform", "stream\$Transform",
                      "Flow Node.js private type"),
    print_type_format("streamWritable", "stream\$Writable",
                      "Flow Node.js private type"),
    print_type_format("string_decoderStringDecoder",
                      "string_decoder\$StringDecoder",
                      "Flow Node.js private type"),
    print_type_format("tlsServer", "tls\$Server",
                      "Flow Node.js private type"),
    print_type_format("tlsTLSSocket", "tls\$TLSSocket",
                      "Flow Node.js private type"),
    print_type_format("ttyReadStream", "tty\$ReadStream",
                      "Flow Node.js private type"),
    print_type_format("ttyWriteStream", "tty\$WriteStream",
                      "Flow Node.js private type"),
    print_type_format("vmContext", "vm\$Context",
                      "Flow Node.js private type"),
    print_type_format("vmScript", "vm\$Script",
                      "Flow Node.js private type"),
    print_type_format("vmScriptOptions", "vm\$ScriptOptions",
                      "Flow Node.js private type"),
    print_type_format("zlibasyncFn", "zlib\$asyncFn",
                      "Flow Node.js private type"),
    print_type_format("zliboptions", "zlib\$options",
                      "Flow Node.js private type"),
    print_type_format("zlibsyncFn", "zlib\$syncFn",
                      "Flow Node.js private type"),

    # Service Workers types
    print_type_format("Cache", description="Flow service worker type"),
    print_type_format("CacheQueryOptions",
    ...
    print_type_format("ClientQueryOptions",
                      description="Flow service worker type"),
    ...
    print_type_format("ExtendableEvent",
                      description="Flow service worker type"),
    print_type_format("FetchEvent", description="Flow service worker type"),
    print_type_format("ForeignFetchOptions",
                      description="Flow service worker type"),
    ...
    print_type_format("NavigationPreloadManager",
                      description="Flow service worker type"),
    print_type_format("NavigationPreloadState",
                      description="Flow service worker type"),
    print_type_format("RegistrationOptions",
                      description="Flow service worker type"),
    ...
    print_type_format("ServiceWorkerContainer",
                      description="Flow service worker type"),
    print_type_format("ServiceWorkerMessageEvent",
                      description="Flow service worker type"),
    print_type_format("ServiceWorkerRegistration",
                      description="Flow service worker type"),
    print_type_format("ServiceWorkerState",
                      description="Flow service worker type"),
    print_type_format("VisibilityState",
                      description="Flow service worker type"),
    ...
    print_type_format("ReadableByteStreamController",
                      description="Flow streams type"),
    print_type_format("ReadableStream", description="Flow streams type"),
    print_type_format("ReadableStreamBYOBRequest",
                      description="Flow streams type"),
    print_type_format("ReadableStreamController",
                      description="Flow streams type"),
    ...
    print_type_format("WritableStreamController",
                      description="Flow streams type"),
